...
/**
 * This class represents a ASN1 structure of AuthenticationObject as defined in PKCS#15
 * @author Lupascu Alexandru
 */
public class AuthenticationObject extends ASN1Type{
	...
	/**
	 * Constructor
	 * @param coa CommonObjectAttributes object
	 * @param caoa CommonAuthenticationObjectAttributes object
	 * @param pa PinAttributes object
	 */
	public AuthenticationObject(CommonObjectAttributes coa,CommonAuthenticationObjectAttributes caoa,PinAttributes pa){
	...
	/**
	 * This method encodes a AuthenticationObject structure.
	...
	/**
	 * This method decodes a AuthenticationObject structure.
	 ...
	 */
      ...
      /**
    	 * This method decodes a AuthenticationObject encoding.
    	...
    	public boolean decode(){
    		...
    		short offset =(short)( 1 + findLengthEncodedLength(encoding, (short)1));
    		 ...
    		 memberlen = (short) decodeLength(encoding, (short) (offset+1));
    		 classAtributes = new CommonAuthenticationObjectAttributes();
    	     ...
    	     memberlen = (short) decodeLength(encoding, (short)(offset+1));
    		 typeAttribute = new PinAttributes();

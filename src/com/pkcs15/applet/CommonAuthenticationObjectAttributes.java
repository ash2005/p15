...
/**
 * This class represents a ASN1 structure of CommonAuthenticationObjectAttributes
 * @author Lupascu Alexandru
 */
public class CommonAuthenticationObjectAttributes  extends ASN1Type{
	...
	public CommonAuthenticationObjectAttributes(OctetString authenticationID){
	...
	/**
	 * This method encodes a CommonAuthenticationObjectAttributes structure.
	...
	public byte[] encode() {
        ...
        lengthEncoded = encodeLength((short)authIdEnc.length);
		
		encoding = new byte[ (short)( 1 + lengthEncoded.length + authIdEnc.length)];
	...
	/**
	 * This method decodes a CommonAuthenticationObjectAttributes structure.
	 ...
	 */
      ...
      /**
  	 * This method decodes a CommonAuthenticationObjectAttributes encoding.

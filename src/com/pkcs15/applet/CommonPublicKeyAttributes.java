...
/**
 * This class represents a ASN1 structure of CommonPublicKeyAttributes as defined in PKCS#15
 * @author Lupascu Alexandru
 */
public class CommonPublicKeyAttributes extends ASN1Type {
	 ...
	 */
	public CommonPublicKeyAttributes(Name subjName){
		subjectName = subjName;
	}
	
	
	/**
	 * This method encodes structure of CommonPublicKeyAttributes
	...
	/**
	 * This method decodes a CommonPublicKeyAttributes structure.
	 ...
	 */
      ...
      /**
  	 * This method decodes a CommonPublicKeyAttributes encoding.

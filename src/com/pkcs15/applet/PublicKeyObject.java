 ...
 * This class represents a ASN1 structure of PublicKeyObject as defined in PKCS#15
 */
public class PublicKeyObject extends ASN1Type{
	 ...
	 * @param cpuka CommonPublicKeyAttributes
	 * @param purka PublicRSAKeyAttributes
	 */
	public PublicKeyObject(CommonObjectAttributes coa,CommonKeyAttributes cka,CommonPublicKeyAttributes cpuka,PublicRSAKeyAttributes purka){
	
		commonObjectAttributes = coa;
		classAtributes = cka;
		subClassAttributes = cpuka;
		typeAttribute = purka;
	...
	/**
	 * This method encodes a PublicKeyObject structure.
	...
	/**
	 * This method decodes a PublicKeyObject structure.
	...
	/**
	 * This method decodes a PublicKeyObject encoding.
	...
	public boolean decode(){
		...
		short offset =(short)( 1 + findLengthEncodedLength(encoding, (short)1));
		 ...
		 memberlen = (short) decodeLength(encoding, (short) (offset+1));
		 subClassAttributes = new CommonPublicKeyAttributes(); 
	     ...
	     offset = (short) (offset + 1 + findLengthEncodedLength(encoding, (short)(offset+1))); 
		 memberlen = (short) decodeLength(encoding, (short) (offset+1));
		 typeAttribute = new PublicRSAKeyAttributes();

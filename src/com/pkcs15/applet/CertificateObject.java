 ...
 * This class represents a ASN1 structure of CertificateObject as defined in PCKS#15
 */
public class CertificateObject extends ASN1Type{
	...
	public CommonCertificateAttributes classAtributes = null;
	
	/*ASN1 structure for X509CertificiateAttributes*/
	public X509CertificateAttributes typeAttribute = null;
	 ...
	 * @param cca CommonCertificateAttributes
	 * @param x5ca X509CertificateAttributes
	 */
	public CertificateObject(CommonObjectAttributes coa,CommonCertificateAttributes cca,X509CertificateAttributes x5ca){
	...
	/**
	 * This method encodes a CertificateObject structure.
	...
	/**
	 * This method decodes a CertificateObject structure.
	...
	/**
	 * This method decodes a CertificateObject encoding.
	...
	public boolean decode(){
		...
		short offset =(short)( 1 + findLengthEncodedLength(encoding, (short)1));
		 ...
		 memberlen = (short) decodeLength(encoding, (short) (offset+1));
		 classAtributes = new CommonCertificateAttributes();
	     ...
	     memberlen = (short) decodeLength(encoding, (short)(offset+1));
		 typeAttribute = new X509CertificateAttributes();

...
/**
 * This class represents the Secret Key Directory File
 * @author Lupascu Alexandru
 *
 */
public class SecretKeyDirectoryFile {
	 ...
	 */
	public SecretKeyDirectoryFile(){}
	
	
	/**
	 * This method adds a SecretKeyObject in the secret key directory file
	 * @param obj SecretKeyObject
	 */
	public void addRecord(SecretKeyObject obj){
	 ...
	 * @param id Unique ID of the secret key
	 * @return SecretKeyObject
	 */
	public SecretKeyObject getRecord(byte[] id){
	...
	/**
	 * This method gets the secret key directory file content
	...
	/**
	 * This method deletes a SecretKeyObject from the secret key directory file
	 * @param id Unique Id of the secret key
	 */
	public void deleteRecord(byte[] id){
		...
		while(node.next !=null){
			 ...
			 try{
			     ...
			     SecretKeyObjectEntry entry = node.next;
